            ...
            menu:
                ...
                cout << "Silahkan pilih : ";cin >>pilihpetualang;
                    if(pilihpetualang==1){
                        ...
                        cout << "3. Pergi ke Menu"<<endl;
                        cout << "4. Kembali ke halaman utama"<<endl;
                        cin  >> pilihkota;
                        if(pilihkota==1){
                            ...
                            if(pilihjual==1){
                                    if(Inventory.empty()){
                                        cout << "Maaf anda tidak memiliki item apapun"<<endl;
                                    }
                                    else {
                                ...
                                if(jumlah_invent <=0){
                                    ...
                                    cout << "Nyawa anda sudah penuh! Item tidak bisa di jual!" << endl;
                                    goto inven;
                                }
                                else {
                                    tengah:
                            ...
                            if(pilihmuseum==1){
                                    while(jawab2=='y' ||jawab2=='Y'){
                                        ...
                                        system("pause");
                                        cout << "\nsebelum akhirnya datang para monster yang mengerikan menghancurkan kota ini dan ingin menguasai seluruh dunia fantasi ini..." <<endl;
                                        system("pause");
                                        cout << "\nSaat itu dunia fantasi ini penuh dengan kehancuran yang di sebabkan oleh para monster laknat tersebut.." << endl;
                                        system("pause");
                                        ...
                                        system("pause");
                                        cout << "\nKini sudah menjadi tugas anda sebagai pahlawan untuk menghentikan rencana dari para monster untuk menguasai kembali dunia fantasi yang damai ini..."<<endl;
                                        system("pause");
